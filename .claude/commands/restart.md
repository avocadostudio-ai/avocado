...
Restart the dev servers for this monorepo, the villa site, the sample site, and the contentful site.

Steps:
1. Kill any processes on ports 3000, 3001, 3002, 3003, 4100, and 4200 (ignore errors if nothing is running)
...
6. Wait a few seconds, then verify each server is responding:
