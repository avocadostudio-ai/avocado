...
const de: LocaleDict = {
  ...
  "header.upToDate": "Aktuell",
  "header.upToDateTooltip": "Seit der letzten Veröffentlichung gibt es nichts zu publizieren.",
  "header.unpublishedTooltip": "{{count}} unveröffentlichte Änderung(en) seit der letzten Veröffentlichung.",
  ...
  "history.publish": "Veröffentlichung",
  "history.deploying": "Wird bereitgestellt…",
  "history.live": "Live",
  "history.deployFailed": "Fehlgeschlagen",
  "history.viewDeploy": "Deploy ansehen",
  "history.pagesPublished": "{{count}} Seiten",
  "history.pagePublished": "1 Seite",
  "history.pagesChanged": "{{changed}} von {{total}} Seiten geändert",
  "history.noContentChanges": "Keine inhaltlichen Änderungen · {{count}} Seiten live",
  ...
  "welcome.greetingDemo": "Willkommen bei {{name}} \u2014 das ist eine Demo-Site zum Ausprobieren. Bearbeite, was du willst, schau dir den [Komponenten-Katalog]({{catalogueUrl}}) an, um zu sehen, was verf\u00fcgbar ist, und wenn du bereit bist, [onboarde deine eigene Site](https://docs.avocadostudio.dev/sites).",
