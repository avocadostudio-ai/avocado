...
const en = {
  ...
  "header.upToDateTooltip": "Nothing to publish since the last deploy.",
  "header.unpublishedTooltip": "{{count}} unpublished change(s) since the last deploy.",
  ...
  "history.restore": "Revert to this",
  "history.restoring": "Reverting...",
  ...
  "history.deploying": "Deploying…",
  "history.live": "Live",
  "history.deployFailed": "Failed",
  "history.viewDeploy": "View deploy",
  "history.pagesPublished": "{{count}} pages",
  "history.pagePublished": "1 page",
  "history.pagesChanged": "{{changed}} of {{total}} pages changed",
  "history.noContentChanges": "No content changes · {{count}} pages live",
  ...
  "sites.confirmDeleteTitle": "Remove site",
  ...
  "imagePicker.editPrompt": "Describe how to change this image\u2026",
  "imagePicker.generatePrompt": "Describe the image you want\u2026",
  "imagePicker.followUpPrompt": "Ask for changes\u2026",
  ...
  "welcome.greetingDemo": "Welcome to {{name}} \u2014 this is a demo site so you can try things out. Edit anything you like, browse the [component catalogue]({{catalogueUrl}}) to see what's available, and when you're ready, [onboard your own site](https://docs.avocadostudio.dev/sites).",
