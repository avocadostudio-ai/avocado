...
Related docs:
- `docs/integration/README.md` — default fast onboarding path (Next.js embedded mode).
- `docs/planning/reduce-nextjs-coupling.md` — rationale for default vs advanced integration tiers.
