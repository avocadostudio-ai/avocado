...
<Note>
**Next.js only (for now).** Avocado Studio is currently built and tested against **Next.js 15+ (App Router)**. Every path on this page assumes your site is — or will be — a Next.js project. Other frameworks can be supported via the [Site Provider SPI](/site-provider-spi), but they're not officially tested and you'll be a first mover.
</Note>
...
There are **two ways** to get a site in:

<CardGroup cols={2}>
  <Card title="Use our Site Assistant" icon="robot" href="/sites/site-agent">
  ...
  <Card title="Code it yourself" icon="code" href="/sites/manual">
...
Both approaches produce the same end state: a Next.js site registered with the orchestrator, with pages, theme, and a wired-in [Site SDK](/integration/nextjs-mvp-embedded). Pick whichever matches your trust level for AI and the complexity of your codebase.
