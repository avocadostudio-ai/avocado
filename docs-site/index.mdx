...
<CardGroup cols={2}>
  ...
  <Card title="Add a site — with the AI Site Agent" icon="robot" href="/sites/site-agent">
  ...
  <Card title="Add a site — code it yourself" icon="screwdriver-wrench" href="/sites/manual">
