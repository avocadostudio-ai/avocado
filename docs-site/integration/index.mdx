...
3. [/integration/nextjs-mvp-adoption-example](/integration/nextjs-mvp-adoption-example)
4. [/integration/templates/nextjs-embedded](/integration/templates/nextjs-embedded)
