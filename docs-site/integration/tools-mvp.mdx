...
- Built-in tools shipped today:
  ...
  - `image.generate` — AI image generation via OpenAI (`gpt-image-1`) or Google Gemini (`gemini-2.5-flash-image`, nicknamed "nano-banana"). Full reference: [Asset Picker & AI Images](/features/asset-picker#imagegenerate-tool-chat-pipeline-path).
