...
|---|---|---|
| `*imageUrl`, `*Image`, `*logo` | Image | Asset Picker modal with Unsplash, Google Drive, CMS libraries, AI generation (OpenAI or Gemini), and local upload. See [Asset Picker & AI Images](/integration/asset-picker). |
