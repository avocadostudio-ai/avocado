...
|---|---|---|
| `*imageUrl`, `*Image`, `*logo` | Image | Asset Manager modal with Unsplash, Google Drive, CMS libraries, AI generation (OpenAI or Gemini), and local upload. See [Asset Manager & AI Images](/features/asset-picker). |
